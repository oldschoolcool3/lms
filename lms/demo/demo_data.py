...
def create_demo_data(setup_args: "dict | None" = None):
...
def create_quiz():
    ...
    questions.append(
        create_quiz_questions("What is the top-level structure in Frappe Learning?", "Chapter", False, "Course", True)
    )
    questions.append(create_quiz_questions("Can you create quizzes in Frappe Learning?", "Yes", True, "No", False))
    questions.append(
        create_quiz_questions("Which of the following content can be added to lessons?", "Bugs", False, "Videos", True)
    )
    questions.append(
...
def create_reviews(course, student):
    ...
    review.rating = 0.8
    review.review = (
        "This is a great course to get started with Frappe Learning. The content is well-structured and easy to follow."
    )
    review.save()
    ...
    return {
        ...
        "blocks": [
            ...
            },
            {
                "id": "tCJD0yMAGd",
                "type": "paragraph",
                "data": {"text": "Frappe Learning automatically detects the video source and embeds it for learners."},
            },
            ...
            {"id": "-H8fLBsAMk", "type": "paragraph", "data": {"text": "<b>Supported URL format</b>"}},
            {
                "id": "Aiq-BfQkwZ",
                "type": "paragraph",
                "data": {"text": '<code class="inline-code">https://www.youtube.com/watch?v=&lt;video-id&gt;</code>'},
            },
            {"id": "8hMi323AbM", "type": "paragraph", "data": {"text": "<b>Example</b>"}},
            {
                "id": "3H6BzIshWg",
                "type": "paragraph",
                "data": {"text": '<code class="inline-code">https://www.youtube.com/watch?v=SLNSSz41v_o</code>'},
            },
